...
try {
    ...
    $tes = $myPDO->query("SELECT suara, jumlah FROM evote.vw_hasil_gubernur;");
    $tes2 = $myPDO->query("SELECT persentase_dari_suara_sah FROM evote.vw_hasil_gubernur;");
    $persentase=array();
    $jumlah=array();
    $keterangan=array();
...
<body class="bg-light">
    ...
    <p class="highcharts-description" style="text-align: center;">
        Diagram ini dibuat atas persetujuan KPUM-FT UTM 2021
    </p>
    </figure>
    <div>
    <script>
