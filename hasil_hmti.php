...
try {
    ...
    $tes = $myPDO->query("SELECT suara, jumlah FROM evote.vw_hasil_hmp WHERE dapil = 'TEKNIK INDUSTRI';");
    $tes2 = $myPDO->query("SELECT persentase_dari_suara_sah_dalam_dapil FROM evote.vw_hasil_hmp WHERE dapil = 'TEKNIK INDUSTRI';");
    $persentase=array();
    $jumlah=array();
    $keterangan=array();
...
<body class="bg-light">
    <div style="margin-left: auto; margin-right: auto;">
        ...
        <h1 style="text-align: center;">Hasil Pemungutan Suara Pemilu Raya FT 2020</h1>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-danger">
        <a class="navbar-brand text-light" href="index.php">Hasil Pemungutan Suara Pemilu E-Vote FT 2020</a>
